  ...
  <div class="">
    <div class="navbar-collapse collapse">
      <div class="btn-group pull-right ">
        ...
        <li><a href="#" id="Trash" class="dropdown-item folder">Trash <span class="glyphicon glyphicon-trash"></span></a></li>
        <li><a href="#" id="Unfiled" class="dropdown-item folder">Unfiled</a></li>
...
<div class="bs-example">
    ...
    <a href="#myModal" class="btn btn-danger btn-info pull-right" data-toggle="modal"><span class="glyphicon glyphicon-plus"></span> new </a></button>
                ...
                <div class="modal-body">
                    <form id="popup" name="popup" action="#" method="post" role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control focus" id="title" name="title">
                        </div>
                        <div class="form-group">
